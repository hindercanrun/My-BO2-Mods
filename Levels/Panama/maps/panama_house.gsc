...
turn_on_reflection_cam( str_extra_cam )
{
	...
	ReflectionCameraEnt = GetEnt( str_extra_cam, "targetname" );

	level.e_tag_origin = Spawn( "script_model", ReflectionCameraEnt.origin );
	level.e_tag_origin SetModel( "tag_origin" );
	level.e_tag_origin.angles = ReflectionCameraEnt.angles;
...
turn_off_reflection_cam( str_extra_cam )
{
	...
	ReflectionCameraEnt delay_thread( 2, ::self_delete );
}

...
setup_objectives()
{
	...
	level.obj_intruder = register_objective( "test" );
	level.obj_follow_mason_1 = register_objective( "Follow Mason" );
    level.obj_kill = register_objective( "Kill" );
    level.obj_survive_standoff = register_objective( "Survive the Standoff" );
	level.obj_follow_mason_2 = register_objective( "Follow Mason" );
...
airfield_objectives()
{
	...
	set_objective( level.obj_follow_mason_1, level.mason, "done" );
	set_objective( level.obj_kill, getstruct( "s_knife_ladder_obj" ) , "kill" );

    flag_wait( "player_climbs_up_ladder" );

    wait 2;

	set_objective( level.obj_kill, undefined, "done" );
/*
